...
*   market clearing
    ...
    mkt_cap_nuc          nuclear lower bound
...
*############################################################
*@                  Set a lower bound for nuclear generation
*############################################################

mkt_cap_nuc("Nuclear",c,t)$(avail("Nuclear",c,t)*cap("Nuclear",c))..
    cap("Nuclear",c)*avail("Nuclear",c,t) *0.3   =L=    GEN("Nuclear",c,t)
;
