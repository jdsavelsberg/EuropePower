...
$load renS pot_ren_mwh gen_ror_exog
$loaddc cinv_0 cinv_1
$loaddc reservoir_size_up reservoir_inflow_up
*not domain checked because not all t are present
$load reservoir_initial_up
$load chp_gen gen_annual gen_monthly
...
$ontext
*we exclude carbon market for now
*---------------------------------------------------------------------
*@@                Carbon market
*---------------------------------------------------------------------
...
$ontext
uncommented by Jonas on 27.05.2026
